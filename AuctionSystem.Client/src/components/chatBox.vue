    ...
    <div class="container-fluid">
        <div id="wrapper">
            ...
            <div class="formInput">
                ...
                <div class="btn btn-submit" name="submitmsg" type="submit" id="submitmsg" value="Send" v-on:click="sendMessage()">Send</div>
            </div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                currentUserCredentials: this.currentUser
            }            
        },
        methods: {
            sendMessage() {
